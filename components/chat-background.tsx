 ...
 */
export function ChatBackground({ children, asBackgroundLayer = false }: ChatBackgroundProps) {
  ...
  const opacity = (useValue("chat_background_opacity") as number) ?? DEFAULT_OPACITY;
...
const styles = StyleSheet.create({
  ...
  backgroundImage: {
    opacity: 0.7, // Image opacity - prominently visible
  },
  overlay: {
